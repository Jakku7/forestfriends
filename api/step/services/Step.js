...
module.exports = {
  ...
  add: async (values) => {
    const data = await Step.create(_.omit(values, _.keys(_.groupBy(strapi.models.step.associations, 'alias'))));
    await strapi.hook.mongoose.manageRelations('step', _.merge(_.clone(data), { values }));
    return data;
  },
